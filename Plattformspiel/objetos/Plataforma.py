import pygame as pg
import random
from objetos import Poder
from configuracoes import LAYER_PLATAFORMA, PLATAFORMA_FASE1, PLATAFORMA_FASE2, PLATAFORMA_FASE3, PLATAFORMA_FASE4, PLATAFORMA_INICIAL, PLATAFORMA_RARA, ASTEROIDES
